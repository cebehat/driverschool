...
Config.CheckPoints = {
	...
	},
	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			QBCore.Functions.Notify(Lang:t('info.go_to_the_next_point_the_speed_limit_is_x_kmh', {speed = Config.SpeedLimits['residence'] - Config.SpeedLimitPadding}), 'primary', 4000)
		end
	},
	{
	...
	},
	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			CreateThread(function()
				QBCore.Functions.Notify(Lang:t('warning.stop_for_pedestrians'), 'error', 4000)
				PlaySound(-1, 'RACE_PLACED', 'HUD_AWARDS', false, 0, true)
				FreezeEntityPosition(vehicle, true)
				Wait(4000)
				FreezeEntityPosition(vehicle, false)
	...
	},
	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			...
			CreateThread(function()
				QBCore.Functions.Notify(Lang:t('info.stop_and_look_to_the_left_it_is_time_to_really_drive_on_the_road_the_speed_limits_in_the_city_are_x_kmh', {speed = Config.SpeedLimits['town'] - Config.SpeedLimitPadding}), 'primary', 4000)
				PlaySound(-1, 'RACE_PLACED', 'HUD_AWARDS', false, 0, true)
				FreezeEntityPosition(vehicle, true)
				Wait(6000)
				FreezeEntityPosition(vehicle, false)
	...
	},
	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			...
			QBCore.Functions.Notify(Lang:t('info.it_is_time_to_drive_on_the_highway_speed_limit_x_kmh', {speed = Config.SpeedLimits['freeway'] - Config.SpeedLimitPadding}), 'primary', 4000)
			PlaySound(-1, 'RACE_PLACED', 'HUD_AWARDS', false, 0, true)
		end
	},
	{
	...
	{
		Pos = vector3(-898.24, -1984.94, 26.24),
		Action = function(playerPed, vehicle, setCurrentZoneType)
			QBCore.Functions.Notify(Lang:t('info.go_to_the_next_point'), 'primary', 4000)
		end
	},
	...
	{
		Pos = vector3(1225.759, -1948.792, 37.19),
		Action = function(playerPed, vehicle, setCurrentZoneType)
